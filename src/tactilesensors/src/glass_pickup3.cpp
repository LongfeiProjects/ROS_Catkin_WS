...
int Force;
double ThresholdPercentage=0.30; // 15%
...
int main(int argc, char **argv)
{
    ...
    int ReturnCode;
    ReturnCode = system("rosrun tactilesensors PollData -sensor 4 -data dynamic &");
    int i = 0;
    ...
    //    getchar();
    ReturnCode = system("rosrun tactilesensors PollData -sensor 4 &");

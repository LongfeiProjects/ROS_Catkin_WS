...
class RobotStateRTMsg(genpy.Message):
  _md5sum = "c9a41401a48e31be6f8bb42baf960171"
...
"""
  __slots__ = ['time','q_target','qd_target','qdd_target','i_target','m_target','q_actual','qd_actual','i_actual','tool_acc_values','tcp_force','tool_vector','tcp_speed','digital_input_bits','motor_temperatures','controller_timer','test_value','robot_mode','joint_modes','effort']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       time,q_target,qd_target,qdd_target,i_target,m_target,q_actual,qd_actual,i_actual,tool_acc_values,tcp_force,tool_vector,tcp_speed,digital_input_bits,motor_temperatures,controller_timer,test_value,robot_mode,joint_modes,effort

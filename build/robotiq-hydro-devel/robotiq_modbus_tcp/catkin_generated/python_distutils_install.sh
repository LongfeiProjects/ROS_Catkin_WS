...
cd "/home/longfei/catkin_ws/src/robotiq-hydro-devel/robotiq_modbus_tcp"
...
/usr/bin/env \
    ...
    build --build-base "/home/longfei/catkin_ws/build/robotiq-hydro-devel/robotiq_modbus_tcp" \
    install \
    $DESTDIR_ARG \
